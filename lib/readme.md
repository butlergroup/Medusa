...
lib | **`pytvmaze`** | [2.0.7](https://pypi.org/project/pytvmaze/2.0.7/) | **`medusa`** | **Modified**: [#1706](https://github.com/butlergroup/Medusa/pull/1706)
lib | `rtorrent-python` | [0.2.9](https://pypi.org/project/rtorrent-python/0.2.9/) | **`medusa`** | Module: `rtorrent`<br>**Modified**: [commit log](https://github.com/butlergroup/Medusa/commits/master/lib/rtorrent)
...
lib | **`simpleanidb`** | pymedusa/[5d26c8c](https://github.com/butlergroup/simpleanidb/tree/5d26c8c146891225c05651821ef34ced0c118221) | **`medusa`** | -
